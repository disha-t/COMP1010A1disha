## Grading
- Code style (based on test marks): Up to 35 
	- For example, if you get 55 out of 65 in your tests, you qualify for 35*(55.0/65) ROUNDED UP = 30 out of 35 marks for coding style. 

	- Marking Guide for code style
		- Commenting (10 marks)
			- 10 if appropriate level of commenting at all places
			- 6 if appropriate level of commenting at most places
			- 2 if appropriate level of commenting at some places
			- 0 if appropriate level of commenting at very few (or no) places
		- Indentation (10 marks)
			- 10 if perfect and consistently-styled indentation everywhere 
			- 6 if perfect and consistently-styled indentation at most places
			- 2 if perfect and consistently-styled indentation at some places 
        ...
        - Delegation (10 marks)
            - 10 if appropriate delegation used at all places
            - 6 if appropriate delegation used at most places
            - 2 if appropriate delegation used at some places
